...
<template>
  <div class="page-stack">
    ...
    <section class="platform-notice"><ShieldCheck :size="20"/><div><strong>Avisos protegidos dentro do Git Monitor</strong><p>O Git Monitor não solicita permissão nem usa pop-ups, notificações do navegador ou avisos do sistema operacional. Alertas aparecem nesta central, no contador da navegação e em mensagens internas da própria plataforma.</p></div></section>
