...
import { AlertTriangle, ChevronLeft, ChevronRight, Github, Plus, Search, SlidersHorizontal, X } from 'lucide-vue-next'
...
async function load(): Promise<void> {
  ...
  errorMessage.value = ''
  try {
    const [repoData, connectionData] = await Promise.all([
