  ...
  routes: [
    { path: '/login', name: 'login', component: () => import('../views/LoginView.vue'), meta: { title: 'Entrar' } },
    {
      path: '/', component: AppShell, meta: { requiresAuth: true }, children: [
        ...
        { path: 'repositories/:id', name: 'repository-detail', component: () => import('../views/RepositoryDetailRealtimeView.vue'), meta: { title: 'Detalhes do repositório' } },
        ...
        { path: 'backup-recovery', name: 'backup-recovery', component: () => import('../views/BackupRecoveryWorkspaceV2.vue'), meta: { title: 'Backup & Recovery' } },
