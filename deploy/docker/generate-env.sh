...
command -v base64 >/dev/null 2>&1 || { echo "O comando base64 não foi encontrado." >&2; exit 1; }
...
Guarde a senha em local seguro. A aplicação exigirá a troca no primeiro acesso.
EOF
